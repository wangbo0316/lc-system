...
export default {
  'navbar.lang': 'English',
  'menu.sysback':'系统后台',
  'menu.sysback.depart':'部门管理',
  'menu.sysback.para':'参数设置',
  'menu.sysback.personnel':'人员管理',
  'menu.workstation':'工作站',
  'menu.workstation.performance':'个人绩效',
  'menu.workstation.transaction':'事项处理',
  'menu.home': '首页',
